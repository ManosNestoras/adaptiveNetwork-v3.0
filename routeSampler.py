...
def get_options(args=None, cmdl=None):
    ...
    if cmdl == True:
        options.routeFiles = PATH + "rou.rou.xml"   
        options.edgeDataFiles = PATH + "dataEdge.xml"
        options.turnFiles = PATH + "turns.xml"
        options.out = PATH + "routesEdge.xml"
        options.vehattrs="departLane=\"best\" departSpeed=\"max\" departPos=\"random\" type=\"car\""
...
if __name__ == "__main__":
    runRouteSampler(get_options(cmdl=True))
